            ...
            <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
                <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0">
                    ...
                    <p className="text-gray-600">
                        Bloggi is a new, revolutionary & cost-effective way to reach your audience as a creator. It's a super-simple, one-time fee that will make your site rank higher on Google and bring in more visitors. We're so confident, we offer a 100% money back guarantee.
                    </p>
                    <div className="pt-1">
                        <NavLink
                            href="/pricing"
                            className="inline-flex items-center gap-x-2 font-medium text-sm text-white bg-[#FF3131] hover:bg-blue-500 active:bg-blue-700 "
                        >
                            Try it out
