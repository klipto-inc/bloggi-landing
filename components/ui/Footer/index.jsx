...
const Footer = () => (
  <footer className='pt-32 sm:pt-20 border border-gray-800 border-opacity-5'>
    <div className='custom-screen text-gray-600'>
      <div className='flex flex-wrap gap-y-10 items-center justify-between'>
        <div className='space-y-4'>
          ...
          <p className='max-w-md'>
            Unlocking the power of content: Empowering you to grow your influence.
          </p>
      ...
      <div className='mt-10 py-10 border-t flex-row-reverse items-center justify-between sm:flex'>
        ...
        <p className='mt-6 sm:mt-0'>
          © 2023 Bloggi - Powered by Klipto Inc. All rights reserved.
        </p>
      </div>
    </div>
  </footer>
